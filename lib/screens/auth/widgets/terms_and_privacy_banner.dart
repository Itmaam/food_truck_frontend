...
class TermsAndPrivacyBanner extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return RichText(
      ...
      text: TextSpan(
        children: [
          TextSpan(text: S.of(context).I_aggree_to, style: Theme.of(context).textTheme.bodyMedium),
          TextSpan(
          ...
          TextSpan(text: S.of(context).and, style: Theme.of(context).textTheme.bodyMedium),
          TextSpan(
